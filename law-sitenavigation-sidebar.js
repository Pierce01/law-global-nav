try
{
  ...
  if (whatsthemenuloc == 'menuleft') { //jb
    ...
    document.write('<div id="siteNavigationTitleWrapper"><div id="siteNavigationTitle"><span><a href="' + navRootLink.getLink() + '" id="siteNavigationLabel" class="navbar-brand">' + navRootLink.getText() + '</a></span> \
                    <button type="button" class="navbar-toggle collapsed" data-bs-toggle="collapse" data-target="#menu" aria-controls="menu" aria-expanded="false" aria-label="Toggle site navigation menu"> \
                    <span class="sr-only">Toggle site navigation menu</span> <span class="icon-bar"></span> <span class="icon-bar"></span> <span class="icon-bar"></span></button><div style="clear:both"></div></div></div>');
